...
<!-- this will show the name of the username -->
...
<p class="over-title margin-bottom-15">Please type the name of the <span class="text-bold">SCHOOL</span> </p><hr>
...
<tbody>
<?php
$query = "SELECT CONCAT(lname, ', ', fname)AS fullname, id, household_id, sex, recorded_grade_level,school_name, municipality, barangay FROM tbl_students_beneficiary_profile ORDER BY fullname";
