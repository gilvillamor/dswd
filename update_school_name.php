...
$db_school_id=$row_edit["school_id"];
...
<input type="text" class="form-control" name="school_id" value="<?php echo $db_school_id; ?>"><br>
...
<a href="school_list.php"><button type="button" class="btn btn-primary btn-wide pull-left">
