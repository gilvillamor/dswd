...
<select class="form-control" name="new_barangay" value="<?php echo $db_barangay; ?>">
...
<a href="student_masterlist.php"><button type="button" class="btn btn-primary btn-wide pull-left">
